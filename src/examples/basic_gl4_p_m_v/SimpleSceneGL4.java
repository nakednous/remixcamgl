package examples.basic_gl4_p_m_v;
...
public class SimpleSceneGL4 extends Scene {	
	...
	Matrix3D model, view, projection; 
    ...
    public void init() {    	
        ...
        shader = new ShaderGL4(this, "/home/pierre/workspace/remixcamgl/src/examples/data/shaders/shader_m_v_p.vert",
    ...
    public void proscenium() {
    	...
    	model = getMatrix();
    	view = getViewMatrix();// same as: view = camera().getViewMatrix();
    	shader.setMatUniform("projectionMatrix", projection);
    	shader.setMatUniform("modelMatrix", model);
    	shader.setMatUniform("viewMatrix", view);    	
