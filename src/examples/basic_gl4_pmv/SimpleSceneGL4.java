package examples.basic_gl4_pmv;
...
public class SimpleSceneGL4 extends Scene {	
	...
	Matrix3D modelview, projection;
	Matrix3D PVM = new Matrix3D();
    ...
    public void init() {    	
        ...
        shader = new ShaderGL4(this, "/home/pierre/workspace/remixcamgl/src/examples/data/shaders/shader_mvp.vert",
    ...
    public void proscenium() {
    	...
    	modelview = getMatrix();  
    	Matrix3D.mult(projection, modelview, PMV);
    	*/
    	// Same as the previous commented lines ;) 	
    	    	    	
    	shader.setMatUniform("PMVMatrix", getModelViewProjectionMatrix());
